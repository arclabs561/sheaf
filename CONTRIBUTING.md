...
Thanks for your interest. sheaf is hierarchical structure, community detection, reconciliation, and conformal prediction.
...
- Commit messages: `sheaf: short lowercase description`. One commit per logical change.
